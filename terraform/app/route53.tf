...
# The hosted zone is managed in the shared root module (terraform/shared/).
# All environments reference it via a data source and only manage their own DNS records.
