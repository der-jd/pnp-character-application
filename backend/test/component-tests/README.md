...
- Create seed characters and history items: Run `scripts/upload-component-test-data.sh --profile <AWS_PROFILE> --env <dev|prod>` to upload test data from `./test-data` to the matching DynamoDB tables
