...
- Use the Cognito user ID (`sub`) of the created test user as `--user-id`. The fixture files store the placeholder `__COMPONENT_TEST_USER_ID__`, which is replaced during upload.
