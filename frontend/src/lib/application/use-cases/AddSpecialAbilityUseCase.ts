...
export class AddSpecialAbilityUseCase implements UseCase<AddSpecialAbilityInput, AddSpecialAbilityOutput> {
   ...
   */
  private characterHasSpecialAbility(character: any, abilityName: string): boolean {
   ...
   */
  private validatePrerequisites(character: any, abilityName: string): { isValid: boolean; error?: string } {
    // Placeholder implementation
