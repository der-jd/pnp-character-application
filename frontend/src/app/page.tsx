  ...
  return (
    <div className="flex h-screen overflow-hidden">
      <div className="w-1/2 relative">
        <Image src="/images/splash-image.png" alt="Splash Image" layout="fill" objectFit="cover" priority />
      </div>
      <div className="w-1/2 flex flex-col items-center justify-center bg-gray-100 overflow-y-auto">
        <div className="w-full max-w-md p-8 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <Link
              href="/auth/signup"
              className="block w-full px-4 py-2 text-center text-blue-600 bg-white border border-blue-600 rounded-md hover:bg-blue-50"
            >
              Sign Up
            </Link>
          </div>
