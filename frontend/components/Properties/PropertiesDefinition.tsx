...
export function render_attribute_icon(attribute: string) {
  switch (attribute) {
    ...
    case Property.COURAGE:
      return <GiThunderStruck size={25} />;
    case Property.INTELLIGENCE:
      return <GiArtificialIntelligence size={25} />;
    case Property.CONCENTRATION:
      return <GiConcentrationOrb size={25} />;
    case Property.CHARISMA:
      return <GiHiveMind size={25} />;
    case Property.MENTAL:
      return <GiHive size={25} />;
    case Property.DEXTERITY:
      return <GiTightrope size={25} />;
    case Property.ENDURANCE:
      return <GiRun size={25} />;
    case Property.STRENGTH:
      return <GiMuscleUp size={25} />;

    // BaseValue cases
    case BaseValue.LP:
      return <GiGlassHeart size={25} />;
    case BaseValue.GG:
      return <GiAwareness size={25} />;
    case BaseValue.INI:
      return <GiPaperArrow size={25} />;
    case BaseValue.ATK:
      return <GiSwordBrandish size={25} />;
    case BaseValue.PAR:
      return <GiSwordClash size={25} />;
    case BaseValue.FK:
      return <GiBowArrow size={25} />;
