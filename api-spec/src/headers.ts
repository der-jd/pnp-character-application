import { z } from "zod";
import { MAX_STRING_LENGTH_LONG, MAX_STRING_LENGTH_VERY_LONG } from "./general-schemas.js";

export const headersSchema = z
  .record(z.string().max(MAX_STRING_LENGTH_LONG), z.string().max(MAX_STRING_LENGTH_VERY_LONG))
  .refine(
